...
module.exports ={
  ...
  // getTopList:(data)=>{
  //   return request('/top/list',data)//排行榜 失效
  // },
  getTopList:(data)=>{
    return request('/toplist/detail',data)//所有排行榜内容摘要
  },
  getDjList:(data)=>{
    return request('/dj/catelist',data) //电台分类 貌似失效
  },
  getDjBanner:(data)=>{
    return request('/dj/banner',data) //电台轮播图
  },
  getHotDj:(data)=>{
    return request('/dj/hot',data) //热门电台
  },
  getPay:(data)=>{
